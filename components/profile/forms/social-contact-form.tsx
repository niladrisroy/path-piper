        ...
        <form onSubmit={form.handleSubmit(handleSave)} className="space-y-8">
          ...
          <div>
            <div className="text-center mb-8">
              <h4 className="text-2xl font-bold text-gray-900 dark:text-white mb-3 flex items-center justify-center">
                <MessageSquare className="h-6 w-6 mr-3 text-blue-600" />
                Social Media Profiles
              </h4>
              <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                Connect your social profiles to showcase your personality and connect with others
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {socialPlatforms.map((link) => (
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:shadow-lg transition-all duration-300 hover:border-blue-300 dark:hover:border-blue-600 group">
                        {/* Platform Header */}
                        <div className="flex items-center space-x-3 mb-4">
                          <div className="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                            <span className="text-blue-600 dark:text-blue-400">{link.icon}</span>
                          </div>
                          <div className="flex-1 min-w-0">
                            <FormLabel className="text-lg font-semibold text-gray-900 dark:text-white block">
                              {link.label}
                            </FormLabel>
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input
                              ...
                              className="border-2 border-gray-200 dark:border-gray-600 rounded-lg focus:border-blue-500 focus:ring-blue-500/20 transition-colors duration-200 bg-gray-50 dark:bg-gray-700/50"
                              {...field}
                            />
                          </div>
                        </FormControl>
            ...
            {/* Quick Tips */}
            <div className="mt-8 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
