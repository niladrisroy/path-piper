...
export default function CircleView({ student }: { student: any }) {
  // Check if there are any connections
  const hasConnections = student.connections && (
    (student.connections.mentors && student.connections.mentors.length > 0) ||
    (student.connections.peers && student.connections.peers.length > 0) ||
    (student.connections.institutions && student.connections.institutions.length > 0)
  )
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Connections Coming Soon</h3>
            <p className="text-gray-500 dark:text-gray-400">
              This section will showcase your network of mentors, peers, and institutions. Database tables for connections are not yet implemented.
            </p>
          </div>
        </div>
      </div>
