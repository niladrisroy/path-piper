      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" title="Privacy Policy" className="text-slate-400 hover:text-teal-400 transition-colors">
                  Privacy Policy
                </a>
              </li>
              <li>
                <a href="#" title="Terms of Service" className="text-slate-400 hover:text-teal-400 transition-colors">
                  Terms of Service
                </a>
              </li>
              <li>
                <a href="#" title="Cookie Policy" className="text-slate-400 hover:text-teal-400 transition-colors">
                  Cookie Policy
                </a>
              </li>
              <li>
                <a href="#safety" title="Safety Center" className="text-slate-400 hover:text-teal-400 transition-colors">
                  Safety Center
                </a>
              </li>
            </ul>
