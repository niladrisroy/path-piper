        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8 md:gap-12 mb-12">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
              The Safe Social Network Built for
            ...
            <div className="flex md:justify-start justify-center items-center">
              ...
              <div className="ml-4">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-slate-600 text-sm">Trusted by 50,000+ students across 100+ countries</span>
                </div>
                <div className="flex items-center gap-2 mt-2 text-xs font-medium text-slate-500">
                  <span className="flex items-center gap-1">🔒 COPPA Compliant</span>
                  <span>·</span>
                  <span className="flex items-center gap-1">✅ GDPR-K Certified</span>
                  <span>·</span>
                  <span className="flex items-center gap-1">🌍 100+ Countries</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="relative mx-auto md:ml-auto">
              <Image
                ...
                width={1200}
                height={675}
                alt="Students using PathPiper education social platform on laptop"
